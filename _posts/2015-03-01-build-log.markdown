...
We needed reasonable solid bearings for the top and bottom of the rotating
...
really needed 3 connections for single phase power, we figured that the
...
{% include image.html url='images/2015-01-11 13.55.09.jpg' description='' %}
...
use it for at the time!). Each Fadecandy is controlled via USB, a connected by
a 1.5m length of USB cable to the Raspiado. The Fadecandies themselves were
...
{% include image.html url='images/2015-01-17 10.47.30.jpg' description='' %}

{% include image.html url='images/2015-01-03 16.21.53.jpg' description='Initially I\'d tired using some alkathyne piping I had left over from The Sensorium, but there really wasn't going to be enough space for the signal wires to get soldered on.' %}

{% include image.html url='images/2015-01-17 10.47.15.jpg' description='' %}

{% include image.html url='images/2015-01-10 20.33.38.jpg' description='' %}
{% include image.html url='images/2015-01-10 20.15.29.jpg' description='' %}
{% include image.html url='images/2015-01-10 20.33.31.jpg' description='' %}

{% include image.html url='images/2015-01-16 14.23.05.jpg' description='' %}
...
{% include image.html url='images/2015-01-15 21.30.54.jpg' description='There were several late nights before kiwiburn soldering things while enjoying a whiskey with ice ball.' %}
...
Another bonus is a wealth of examples for creating pattern generation code.
...
{% include image.html url='images/2015-01-14 09.40.03.jpg' description='' %}

{% include image.html url='images/2015-01-14 17.05.21.jpg' description='' %}
...
{% include image.html url='images/2015-01-17 20.26.52.jpg' description='' %}
